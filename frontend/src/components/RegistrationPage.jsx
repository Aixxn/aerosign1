...
export default function RegistrationPage({ onSuccess, onNavigateToLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true)
      setFormData({ fullName: '', email: '', password: '', termsAccepted: false })
      setFieldErrors({})
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-0 overflow-hidden shadow-none">
        ...
        <div className="hidden md:flex flex-col justify-between p-12 bg-surface-container-low reg-viewport-clip">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-headline font-bold text-on-surface leading-tight tracking-tight">
              ...
              <div className="flex items-start gap-3 pt-2">
                ...
                <div className="flex-1">
                  ...
                  {fieldErrors.termsAccepted && (
                    <p id="terms-error" className="text-error text-xs mt-1">
                      {fieldErrors.termsAccepted}
                    </p>
                  )}
                </div>
            ...
            <footer className="mt-12 text-center">
              <p className="text-sm text-on-surface-variant">
                ...
                <button
                  ...
                  className="text-primary font-bold ml-1 hover:underline decoration-2 underline-offset-4 transition-all bg-none border-none p-0 cursor-pointer"
                >
                  Sign In
                </button>
              </p>
