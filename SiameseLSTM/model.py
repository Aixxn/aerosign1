...
class SiameseLSTM(nn.Module):
    ...
    def __init__(self, input_size=3, hidden_size=256, num_layers=3, use_attention=False, dropout_rate= 0.3, dense_size=128, dense_dropout=0.3):
        ...
        self.fc2 = nn.Linear(dense_size, dense_size//2)
        self.dropout2 = nn.Dropout(dense_dropout)
        self.fc3 = nn.Linear(dense_size//2, dense_size//4)
